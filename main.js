...
const translations = {
    en: {
        ...
        'projects.p3.title':'Book Library Manager',
        'projects.p3.desc': 'A full-stack web app to manage your reading list. Users can add books with cover images uploaded directly to AWS S3, track reading status (Want to Read, Reading, Read), and view personal reading statistics on a responsive dashboard. Built with React + Chakra UI, Node.js + Express, PostgreSQL, and JWT authentication — deployed on Vercel and Railway.',
        'projects.p3.f1': 'User Auth',
        'projects.p3.f2': 'S3 Cover Upload',
        'projects.p3.f3': 'Reading Stats',
        'projects.p3.f4': 'Responsive UI',
        'projects.p3.btn': 'View Live',
    ...
    es: {
        ...
        'hero.tag':       'Desarrollador de Software',
        ...
        'projects.p3.title':'Gestor de Biblioteca',
        'projects.p3.desc': 'Una aplicación web full stack para gestionar tu lista de lectura. Los usuarios pueden agregar libros con portadas subidas directamente a AWS S3, seguir el estado de lectura (Quiero Leer, Leyendo, Leído) y ver estadísticas personales en un panel responsivo. Construida con React + Chakra UI, Node.js + Express, PostgreSQL y autenticación JWT — desplegada en Vercel y Railway.',
        'projects.p3.f1': 'Autenticación',
        'projects.p3.f2': 'Subida S3',
        'projects.p3.f3': 'Estadísticas',
        'projects.p3.f4': 'UI Responsiva',
        'projects.p3.btn': 'Ver en Vivo',
